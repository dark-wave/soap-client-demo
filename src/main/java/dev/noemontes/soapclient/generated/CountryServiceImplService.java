 ...
 * 
 */
@WebServiceClient(name = "CountryServiceImplService", targetNamespace = "http://service.soapserver.noemontes.dev/", wsdlLocation = "http://localhost:8888/ws/country?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRYSERVICEIMPLSERVICE_QNAME = new QName("http://service.soapserver.noemontes.dev/", "CountryServiceImplService");
    ...
    public CountryService getCountryServiceImplPort() {
        return super.getPort(new QName("http://service.soapserver.noemontes.dev/", "CountryServiceImplPort"), CountryService.class);
    }
    ...
    public CountryService getCountryServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soapserver.noemontes.dev/", "CountryServiceImplPort"), CountryService.class, features);
    }
